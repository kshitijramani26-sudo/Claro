...
- What changed:
  ...
  - Note: local services/api/.env points to a *different* Supabase project (`lvymzqwgtykhuhorfcwm`) than live Render (`dmcuwrtjtnigktqxccln`); tests/migrations run against whichever DB the process connects to.
